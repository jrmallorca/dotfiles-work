...
abbr e. 'z $USERPROFILE/dotfiles-work/ubuntu-20.04/ && zf -command search_edit'
...
abbr emp 'z ~/company-projects && zf -command search_edit'
abbr emP 'z $USERPROFILE/company-projects && zf -command search_edit'
...
abbr zn 'z ~/neorg && zf'
abbr zp 'z ~/company-projects && zf'
abbr zP 'z $USERPROFILE/company-projects && zf'
abbr zsp 'z ~/self-projects && zf'
abbr zsP 'z $USERPROFILE/self-projects && zf'
